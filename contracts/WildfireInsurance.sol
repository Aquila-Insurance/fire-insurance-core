...
contract WildfireInsurancev1 is ChainlinkClient, Ownable {
    //LOGS
    ...
    //uint256 public premium = 0.01 * 10**18;
    struct product {
        uint256 prodId;
        uint256 price;
    ...
    {
        //premium = _premium;
        require(msg.value >= 0.01*10**18, "Less than minimum 0.01 Eth"); //0.01 ETH
